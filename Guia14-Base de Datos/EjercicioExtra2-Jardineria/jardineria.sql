...
INNER JOIN empleado  ON cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
INNER JOIN pago  ON cliente.codigo_cliente = pago.codigo_cliente
INNER JOIN oficina ON oficina.codigo_oficina = oficina.codigo_oficina;
...
SELECT e.nombre AS empleado, 
    ...
    WHERE codigo_empleado = e.codigo_jefe) AS jefe
FROM empleado e;
...
SELECT cliente.codigo_cliente, cliente.nombre_cliente, pago.codigo_cliente
FROM cliente
LEFT JOIN pago 
...
pedido.*/
SELECT cliente.codigo_cliente, cliente.nombre_cliente, pedido.codigo_cliente
FROM cliente
LEFT JOIN pedido
...
WHERE oficina.codigo_oficina IS NULL AND cliente.codigo_empleado_rep_ventas IS NULL;
 ...
 -- para mostrar los registros por separado
